	...
	<?php if ( $minutes_left ) : ?>
		<p>
			<?php if ( 1 === (int) $minutes_left ) : ?>
				<?php printf( __( '<strong>%d minute</strong> to go before these post type are no longer registered.', 'custom-post-type-cleanup' ), $minutes_left ); ?>
		...
		<p>
			<?php _e('This plugin is registering all unused custom post types for a limited time.', 'custom-post-type-cleanup'); ?>
		</p>
